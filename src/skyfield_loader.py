...
Usage:
    from skyfield_loader import load_ephemeris

    # Load ephemeris (downloads with SSL fallback if needed)
    eph = load_ephemeris('de421.bsp')
...
def ensure_ephemeris(filename='de421.bsp'):
    """
    ...
    -----------
    filename : str
        Name of the ephemeris file (default: 'de421.bsp')
...
def load_ephemeris(filename='de421.bsp'):
    """
